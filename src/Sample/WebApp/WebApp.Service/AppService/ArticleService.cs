...
namespace WebApp.Service.AppService
{
    public class ArticleService : IArticleService
    {
        ...
        [HystrixCommand(nameof(HystrixGetFallBack), MaxRetryTimes = 5)]
        public m_Article HystrixGet(int id)
        {
            throw new NotImplementedException();
        }

        public void HystrixGetFallBack(int id)
        {
            return;
        }
